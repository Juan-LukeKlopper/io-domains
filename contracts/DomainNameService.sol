...
contract DomainNameService is ERC721URIStorage {
    ...
    function register(string calldata name) public payable{
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    ...
                    '{"name": "',
                    _name,
                    '", "description": "A domain on the IO name service", "image": "data:image/svg+xml;base64,',
        ...
        _tokenIds.increment();
        console.log("%s has registered the custom IO domain %s", msg.sender,_name);
    }
